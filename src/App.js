  ...
  const apps = [
    {
      name: 'Video Download',
      image: currency,
      link: 'https://play.google.com/store/apps/details?id=com.videodownloader.videoplayer.video.saver.free'
    }
  ];
